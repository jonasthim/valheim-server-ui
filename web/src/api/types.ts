...
export type NotifyChannelType = Schemas['NotifyChannelType']
export type AlertKind = Schemas['AlertKind']
export type NotifyChannel = Schemas['NotifyChannel']
export type NotifySettings = Schemas['NotifySettings']
export type NotificationLogEntry = Schemas['NotificationLogEntry']
...
export type InstanceEvent = Schemas['InstanceEvent']
export type LogFileInfo = Schemas['LogFileInfo']
export type LogMatch = Schemas['LogMatch']
...
export type SetPlayerNoteRequest = Schemas['SetPlayerNoteRequest']
export type World = Schemas['World']
export type BackupKind = Schemas['BackupKind']
export type Backup = Schemas['Backup']
export type BackupTargetType = Schemas['BackupTargetType']
export type BackupTarget = Schemas['BackupTarget']
export type RemoteBackupConfig = Schemas['RemoteBackupConfig']
...
export type ChatLogEntry = Schemas['ChatLogEntry']
