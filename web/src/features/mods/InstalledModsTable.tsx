  ...
  return (
    ...
    >
      <DataTable
        ...
        rowKey={(mod) => mod.id}
        minWidth={720}
        empty={<EmptyState icon={<IconPackage size={22} />} title="No mods installed yet. Browse Thunderstore or upload a mod below." />}
        actions={
          canOperate
            ? (mod) => (
                <Group gap={4} wrap="nowrap" justify="flex-end">
                  ...
                  <Tooltip label="Uninstall">
                    <ActionIcon variant="subtle" color="red" aria-label={`Uninstall ${mod.name}`} onClick={() => confirmUninstall(mod)}>
                      <IconTrash size={16} />
                    </ActionIcon>
                  </Tooltip>
                </Group>
