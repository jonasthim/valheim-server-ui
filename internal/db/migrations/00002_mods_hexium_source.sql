-- +goose Up
-- Allow "hexium" as a mod source alongside "thunderstore" and "manual".
...
-- +goose Down
-- Reverting drops any hexium-sourced rows, which the old constraint forbids.
...
INSERT INTO mods_old SELECT * FROM mods WHERE source IN ('thunderstore','manual');
DROP TABLE mods;
